...
{
    Task<IEnumerable<RoutineExecutionLog>> GetByRoutineId(Guid routineId, int page, int pageSize);
    Task<IEnumerable<RoutineExecutionLog>> GetByUserId(Guid userId, int page, int pageSize);
    Task<IEnumerable<RoutineExecutionLog>> GetByDeviceId(Guid deviceId, int page, int pageSize);
